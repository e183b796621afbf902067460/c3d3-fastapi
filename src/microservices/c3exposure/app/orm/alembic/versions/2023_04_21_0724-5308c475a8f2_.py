...
Revision ID: 5308c475a8f2
Revises: 
Create Date: 2023-04-21 07:24:03.603493
...
def upgrade() -> None:
    ...
    op.create_table('l_exchanges_symbols',
    ...
    op.create_table('l_exchanges_symbols_labels',
    ...
    op.create_table('l_exchanges_tickers_labels',
