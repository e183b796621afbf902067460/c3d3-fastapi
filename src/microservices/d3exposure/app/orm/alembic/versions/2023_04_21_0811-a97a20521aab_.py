...
Revision ID: a97a20521aab
Revises: 
Create Date: 2023-04-21 08:11:43.325438
...
def upgrade() -> None:
    ...
    op.create_table('l_addresses_chains_labels',
    ...
    op.create_table('l_addresses_chains_protocols_specifications_labels',
    ...
    op.create_table('l_tokens_on_wallets',
